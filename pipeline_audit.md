...
> Analysis only — no code changed. Target runtime model: **google/gemini-3.5-flash-lite** (cheap, literal-minded, recency-biased). Every finding below is evaluated against the question: *"will a lightweight model get this right on the first try?"*
