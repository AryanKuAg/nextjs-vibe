  ...
  return (
    <div className="min-h-screen bg-[#1C1C1C] font-inconsolata">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h1 className="text-[40px] font-[500] text-white mb-4">Compliance</h1>
        ...
        <div className="space-y-10 text-sm text-[#CCCCCC] leading-relaxed">
          <section>
            <h2 className="text-white text-base mb-3">1. Our commitment</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">2. Data protection</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">3. Security practices</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">4. Sub-processors and third parties</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">5. AI and responsible use</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">6. Accessibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">7. Reporting concerns</h2>
