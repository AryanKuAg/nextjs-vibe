...
export const metadata = {
  title: "Cookie policy – Spatial",
  description: "How Spatial uses cookies and similar technologies.",
};
  ...
  return (
    <div className="min-h-screen bg-[#1C1C1C] font-inconsolata">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h1 className="text-[40px] font-[500] text-white mb-4">Cookie policy</h1>
        ...
        <div className="space-y-10 text-sm text-[#CCCCCC] leading-relaxed">
          <section>
            <h2 className="text-white text-base mb-3">1. What this policy covers</h2>
            <p>
              This Cookie Policy explains how Spatial&rsquo;s websites and web applications (&ldquo;Service&rdquo;) use cookies, pixels, local storage, and similar technologies (&ldquo;cookies&rdquo;). Please read it together with our Privacy Policy.
            </p>
          </section>

          <section>
            <h2 className="text-white text-base mb-3">2. What cookies are</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">3. How long cookies last</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">4. Types of cookies we use</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">5. Third-party technologies</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">6. Your choices</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">7. Do Not Track</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">8. Updates</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">9. Contact</h2>
