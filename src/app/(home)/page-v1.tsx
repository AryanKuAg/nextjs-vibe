...
const SitePreviewCard = ({ title, href, imgSrc }: SitePreviewCardProps) => (
  <a
    ...
    className="group block rounded-[24px] font-sans overflow-hidden relative"
  >
...
const BenefitCard = ({ iconClass, title, description }: { iconClass: string; title: string; description: string }) => (
  <div className="flex flex-col p-6 bg-gradient-to-b from-[#282828] to-[#282828]/40 rounded-[24px] font-sans">
...
const FeatureCard = ({ step, title, description, children }: FeatureCardProps) => (
  <div className="flex flex-col gap-2 group p-2 bg-gradient-to-b from-[#282828] to-[#282828]/40 rounded-[24px] font-sans">
...
const BrowseTemplatesButton = () => {
  ...
  const btnClass = "px-6 py-3.5 rounded-[12px] border border-[#2c2c2c] hover:bg-white/4 transition-colors text-white text-sm font-[500] font-sans flex items-center justify-center disabled:opacity-50";
    ...
    <main className="min-h-screen bg-background selection:bg-white/20 pb-0 flex flex-col">
      ...
      <header className="relative min-h-[100vh] flex flex-col items-center justify-end pb-6 md:pb-[40px] px-4 overflow-hidden">
        ...
        >
          ...
          <motion.p variants={heroItemVariants} className="font-[500] font-sans text-white mb-8 md:mb-[40px] text-sm text-center">
      ...
      <FadeInSection className="py-[60px] md:py-20 px-4 sm:px-6 max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center mb-10">
          ...
          <motion.p variants={itemVariants} className="text-center font-sans text-[#737373] text-sm font-[500]">From prompt to cinematic website in just three simple steps.</motion.p>
        </div>
      ...
      <FadeInSection id="features" className="py-[60px] md:py-20 px-4 sm:px-6 max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center mb-10">
          ...
          <motion.p variants={itemVariants} className="text-center font-sans text-[#737373] text-sm font-[500]">Fastest way to go from a text prompt to a live, production-ready 3D website.</motion.p>
        </div>
      ...
      <FadeInSection id="sites" className="py-[60px] md:py-20 px-4 sm:px-6 max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center mb-10">
          ...
          <motion.p variants={itemVariants} className="text-center font-sans text-[#737373] text-sm">Not sure where to start? Pick a scene built with our 3d scroll library.</motion.p>
        </div>
        ...
        <motion.div variants={itemVariants} className="mt-10 flex justify-center font-sans">
