  ...
  return (
    <div className="min-h-screen bg-[#1C1C1C] font-inconsolata">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h1 className="text-[40px] font-[500] text-white mb-4">Terms of service</h1>
        ...
        <div className="space-y-10 text-sm text-[#CCCCCC] leading-relaxed">
          <section>
            <h2 className="text-white text-base mb-3">1. Agreement</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">4. Plans and payments</h2>
            <p className="mb-2">Some features require a paid plan or usage-based fees, as shown at checkout or on our pricing pages.</p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">5. Acceptable use</h2>
          ...
          <section>
            <h2 className="text-white text-base mb-3">6. Your content</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">7. AI outputs</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">8. Our IP</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">9. Third-party services</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">10. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">11. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">12. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">13. Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">14. Changes</h2>
            <p>
          ...
          <section>
            <h2 className="text-white text-base mb-3">15. Contact</h2>
