          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[#2A2A28]/50">
              ...
              <Button
                ...
                className="bg-transparent text-white border border-[#3B3B3B] hover:bg-[#2A2A28] h-9 px-4 rounded-[8px] text-sm font-sans"
              >
            ...
            <div className="flex items-center justify-between pb-4">
              ...
              <Button
                ...
                className="bg-transparent text-[#F1336E] border border-[#3B3B3B] hover:bg-[#F1336E]/10 h-9 px-4 rounded-[8px] text-sm font-sans transition-colors disabled:opacity-50"
              >
