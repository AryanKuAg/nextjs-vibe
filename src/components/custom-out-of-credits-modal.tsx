    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <h2 className="text-3xl md:text-[40px] text-white font-sans mb-4 tracking-tight font-[500]">Upgrade to keep creating</h2>
          <p className="text-neutral-400 text-sm leading-sm font-sans mx-auto">
