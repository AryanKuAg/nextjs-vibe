...
export const TEMPLATE_REGISTRY: TemplateManifest[] = [
  {
    ...
    branch: "main",
    mode: "FULL_PAGE",
    demoUrl: "https://beach-house.vercel.app",
    imgSrc: "https://assets.framerate.space/templates/planet%20robot/template.jpg",
  },
  // {
  //   id: "orbis",
  //   title: "Orbis",
  //   repo: "framerate-space/template-orbis",
  //   branch: "main",
  //   mode: "FULL_PAGE",
  //   demoUrl: "https://orbisframerate.netlify.app",
  //   imgSrc: "https://assets.framerate.space/templates/planet%20robot/template.jpg",
  // },
  // {
  //   id: "theo",
  //   title: "Theo",
  //   repo: "framerate-space/template-theo",
  //   branch: "main",
  //   mode: "FULL_PAGE",
  //   demoUrl: "https://theoframerate.netlify.app/",
  //   imgSrc: "https://assets.framerate.space/templates/Theo/Template.png",
  // },
  // {
  //   id: "strata",
  //   title: "Strata",
  //   repo: "framerate-space/template-strata",
  //   branch: "main",
  //   mode: "FULL_PAGE",
  //   demoUrl: "https://strataframerate.netlify.app/",
  //   imgSrc: "https://assets.framerate.space/templates/stone/template.png",
  // },
  // {
  //   id: "aether",
  //   title: "Aether",
  //   repo: "framerate-space/template-aether",
  //   branch: "main",
  //   mode: "FULL_PAGE",
  //   demoUrl: "https://spacexmarsmission.netlify.app",
  //   imgSrc: "https://assets.framerate.space/mars_template.jpg",
  // },
  // {
  //   id: "obsidian",
  //   title: "Obisidian",
  //   repo: "framerate-space/template-obsidian",
  //   branch: "main",
  //   mode: "FULL_PAGE",
  //   demoUrl: "https://obisidianframerate.netlify.app",
