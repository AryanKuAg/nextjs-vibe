  ...
  return (
    <>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 z-10">
        <span className="text-white font-sans text-sm tabular-nums">
          {Math.round(pct)}%
        </span>
      ...
      >
        ...
        <div className={cn(
          ...
          <div className="flex items-center justify-between p-3 border-b border-[#2c2c2c]">
            <h3 className="text-white text-sm font-sans">{title}</h3>
          ...
          <div className="p-3 pt-3">
            <div className="grid grid-cols-2 gap-3 mb-3 ">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-white text-sm font-sans">Start frame</span>
                ...
                <div className="aspect-video bg-transparent rounded-[8px] flex items-center justify-center border border-[#2c2c2c] overflow-hidden relative">
                  ...
                  {!block.isGeneratingStart && block.startFrameUrl ? (
                    ...
                    <span className="text-[#ccc] text-sm font-sans">
                      {index > 0 ? (
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-white text-sm font-sans">End frame (Optional)</span>
                ...
                <div className="aspect-video bg-transparent rounded-[8px] flex items-center justify-center border border-[#2c2c2c] overflow-hidden relative">
                  ...
                  {!block.isGeneratingEnd && block.endFrameUrl ? (
                    ...
                    <span className="text-[#ccc] text-sm font-sans">Prompt to generate</span>
                  ) : null}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                <span className="text-white text-sm font-sans">Video</span>
              ...
              >
                {block.isGeneratingVideo ? (
                  ...
                  <span className="text-[#ccc] text-sm font-sans">Preview your generated video here</span>
                )}
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-col pb-20 w-full max-w-4xl mx-auto px-4">
        ...
        {blocks.length < 4 && (
          <button
            ...
            className={cn(
              "w-full rounded-[8px] border border-[#2c2c2c] bg-transparent text-white text-sm font-sans transition-colors h-[32px] max-w-[640px] mx-auto",
